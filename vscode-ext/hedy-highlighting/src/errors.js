const higlitingHedyErrors = {
  ...
  "hy-entity-changes-content-type": {
    message:
      "Vigila que la variable '[NAME]' ha canviat el tipus a respecte la seva definició a la línia [LINE].",
    severity: "warning",
    priority: 0,
  },
  "hy-at-begining": {
  ...
  "hy-command-unexpected-argument": {
    ...
    messagePlural:
      "La comanda '[NAME]' només accepta [VALUE] arguments després.",
  ...
  "hy-execting-function-definition": {
    message: "S'espera una definició de funció. El format correcte és 'define <nom>' o a partir de nivell 13 'define <nom> with <arg1>, <arg2> <...>'.",
    severity: "error",
    priority: 1,
},
  ...
  "hy-level-unavailable-yet": {
    message:
      "La comanda '[NAME]' encara no es pot fer servir en aquest nivell.",
    severity: "error",
    priority: 2,
  },
  ...
  "hy-to-lowercase-command": {
    message:
      "Potser volies utilitzar la comanda '[LOWER]'?, si és així ha d'estar tota en minúscules.",
    severity: "warning",
    priority: 3,
  },
  ...
  "hy-same-comparison-true": {
    message:
      "No té massa sentit comparar dos cops el mateix. Sempre serà cert.",
    severity: "warning",
    priority: 6,
  },
  "hy-same-comparison-false": {
    message:
      "No té massa sentit comparar dos cops el mateix. Sempre serà fals.",
    severity: "warning",
    priority: 6,
  },
  ...
  "hy-use-elseif-instead": {
    message:
      "Si després d'un 'else' vols fer 'if', utilitza la comanda 'elif'.",
    severity: "warning",
    priority: 10,
  },
  "hy-after-needs-list": {
  ...
  "hy-pressed-must-be-second": {
    message:
      "La comanda '[NAME]' ha d'anar en segona posició, després de 'is'.",
    severity: "warning",
    priority: 100,
  },
  "hy-turn-left-right": {
    message:
      "La comanda '[NAME]' només accepta 'left' o 'right' en aquest nivell.",
    severity: "error",
    priority: 100,
  },
...
function command2català(command) {
  const commands = {
...
class HHErrorType extends HHError {
  ...
  _process_messsage(message) {
    ...
    if (this.type.startsWith("constant_number")) {
      if (this.type === "constant_number_decimal") tipus = "un número decimal";
      ...
      tipus = "una variable";
    } else if (this.type.startsWith("command")) {
      tipus = "la comanda " + command2català(this.type.replace("command_", ""));
    }
